...
static const std::map<std::string,std::string> M_DEC = {
...
//cffex 中金所 --- 5 --- 20180109 ----------------------------------------------------------
static const std::map<std::string,std::string> M_CFFEX = {
...
static const std::map<std::string,std::string> aaaa = {
  {"zP","{\"m\":[1,3,5,7,10,11,12]}"},
  {"aa", "aaaa"},
  {"bb", "aabbaa"},
  {"cc", "aicaaa"},
  {"dd", "daa"},
...
int main()
{
  ...
  for(auto it = M_CFFEX.begin(); it != M_CFFEX.end(); ++it) {
    std::cout << it->first << ", " << it->second << '\n';
  }
  for(auto it = M_SHFE.begin(); it != M_SHFE.end(); ++it) {
    std::cout << it->first << ", " << it->second << '\n';
  }
  for(auto it = M_DEC.begin(); it != M_DEC.end(); ++it) {
    std::cout << it->first << ", " << it->second << '\n';
  }
